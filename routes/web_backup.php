...
Route::middleware(['auth', 'verified', 'role:Administrator,Dokter,Resepsionis,Perawat'])->prefix('admin')->group(function () {
    ...
    // View: Administrator, Dokter, Resepsionis, Perawat, Pemilik (own pets only)
    // CRUD: Administrator, Dokter (full), Perawat (main record only)
    // Note: Specific routes (without parameters) must come before parameterized routes
    Route::middleware('role:Administrator,Dokter,Resepsionis,Perawat,Pemilik')->group(function () {
    ...
    // Full CRUD for Administrator and Dokter
    Route::middleware('role:Administrator,Dokter')->group(function () {
        ...
        // Detail tindakan management (full access)
    ...
    // Main record editing for Administrator, Dokter, and Perawat
    ...
    // View-only routes moved up already
    ...
    // View: Administrator, Resepsionis, Perawat, Pemilik (own appointments)
    // CRUD: Administrator, Resepsionis, Pemilik (own appointments)
    // Note: Specific routes (without parameters) must come before parameterized routes
    Route::middleware('role:Administrator,Resepsionis,Perawat,Pemilik')->group(function () {
    ...
    Route::middleware('role:Administrator,Resepsionis,Pemilik')->group(function () {
        // Specific routes without parameters - must come first
    ...
    // Routes accessible by view roles (removed - moved up already)
    ...
    // Pet Management Routes
    // View: Administrator, Resepsionis, Pemilik (own pets only)
    // CRUD: Administrator, Resepsionis, Pemilik (own pets only)
    Route::middleware('role:Administrator,Resepsionis,Pemilik')->group(function () {
        ...
        Route::get('/pet/{id}', [App\Http\Controllers\Admin\PetController::class, 'show'])->name('admin.pet.show');
