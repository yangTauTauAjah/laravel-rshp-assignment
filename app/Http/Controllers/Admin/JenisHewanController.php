...
class JenisHewanController extends Controller
{
    ...
    public function destroyJenis($id)
    {
        ...
        if ($jenis->rasHewan()->count() > 0) {
            return redirect()->route('admin.jenis-hewan.index')->with('error', 'Tidak dapat menghapus jenis hewan yang masih memiliki ras');
        }
    ...
    public function storeRas(Request $request)
    {
        ...
        return redirect()->route('admin.jenis-hewan.index')->with('success', 'Ras hewan berhasil ditambahkan');
    }
    ...
    public function updateRas(Request $request, $id)
    {
        ...
        return redirect()->route('admin.jenis-hewan.index')->with('success', 'Ras hewan berhasil diperbarui');
    }
    ...
    public function destroyRas($id)
    {
        ...
        return redirect()->route('admin.jenis-hewan.index')->with('success', 'Ras hewan berhasil dihapus');
    }
}
