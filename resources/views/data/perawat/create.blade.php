    ...
    <div class="mx-auto my-6 max-w-4xl w-full flex-1">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-6 border-b border-gray-200">
                <h3 class="text-lg font-medium text-rshp-dark-gray">Informasi Perawat</h3>
                <p class="text-sm text-gray-600 mt-1">Isi semua informasi yang diperlukan untuk profil perawat</p>
            </div>
            ...
            <div class="p-6">
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-600 mb-4">
                        Semua user sudah memiliki role Perawat, atau belum ada user yang dapat diberikan role Perawat.
            ...
            <form action="{{ route('admin.perawat.store') }}" method="POST" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-2 text-sm text-blue-600">
                        ...
                        User yang dipilih akan otomatis diberikan role "Perawat" setelah profil dibuat
                    </p>
                    @error('iduser')
