    ...
    <div class="mx-auto my-6 max-w-4xl w-full flex-1">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-rshp-dark-gray">{{ $dokter->nama }}</h2>
                            <p class="text-rshp-green font-medium">{{ $dokter->bidang_dokter }}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            ...
                            <span class="text-rshp-dark-gray">{{ $dokter->email }}</span>
                        </div>
                        
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            <span class="text-gray-600 font-medium">Bidang Keahlian:</span>
                            <span class="text-rshp-dark-gray">{{ $dokter->bidang_dokter }}</span>
                        </div>
                        
                        <div class="flex justify-between items-center py-2 border-b border-gray-100">
                            <span class="text-gray-600 font-medium">Status Akun:</span>
                            <span class="text-rshp-dark-gray">
                                {{ $dokter->user_status == 1 ? 'Aktif' : 'Nonaktif' }}
                            </span>
                        </div>
                        ...
                        <div class="flex justify-between items-center py-2">
                            ...
                            <span class="text-rshp-dark-gray">
                                {{ \Carbon\Carbon::parse($dokter->user_created_at)->format('d M Y') }}
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-rshp-green">-</p>
                        <p class="text-xs text-gray-500 mt-1">Dalam pengembangan</p>
                    </div>
                    <div class="h-12 w-12 bg-green-100 rounded-lg flex items-center justify-center">
                        <svg class="h-6 w-6 text-rshp-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Pasien Ditangani</p>
        ...
        <div class="bg-white rounded-lg shadow-lg max-w-md w-full mx-4">
            <div class="p-6">
                ...
                <p class="text-sm text-gray-600 mb-6">
                    Apakah Anda yakin ingin menghapus profil dokter <strong>{{ $dokter->nama }}</strong>? 
